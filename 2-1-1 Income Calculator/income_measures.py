"""
Class containing methods for calculating the Area Median Income, the Federal Poverty Level, and the State Median Income.
These functions are based on the direct calculations Hannah used in the Excel income calculator, and thus
aren't necessarily the best or most accurate ways of calculating them in Python.
